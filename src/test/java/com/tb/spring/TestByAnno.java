...
public class TestByAnno {
	...
	public void test1() {
		...
		udao1.getUserId("zhangsan");
		udao2.getUserId("zhangsan");
	}
	...
	public void test2() {
		...
		Assert.assertEquals(5,p1.getHero().size());
		Assert.assertEquals("蒋门神",p1.getHero().get(2));
	}
	...
	public void test3() {
		...
		Assert.assertEquals(null,p1.getHero());
	}
